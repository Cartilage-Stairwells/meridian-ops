...
/- ─────────────────────────────────────────────────────────────────
   FCO-CLOSURE-CHECK — test harness (NOT part of the v1.1 artifact)
   Purpose: (1) axiom audit of all 13 theorems;
            (2) labeled evaluation of all 25 canReach cells for
                independent comparison against an external BFS closure.
   ───────────────────────────────────────────────────────────────── -/

open TSCP.CustodyPlane

#print axioms TSCP.CustodyPlane.custody_receipt_no_authority_path
#print axioms TSCP.CustodyPlane.custody_no_authority
#print axioms TSCP.CustodyPlane.evidence_no_authority
#print axioms TSCP.CustodyPlane.receipt_no_authority
#print axioms TSCP.CustodyPlane.custody_plane_separation
#print axioms TSCP.CustodyPlane.no_plane_crossing
#print axioms TSCP.CustodyPlane.receipt_in_custody_plane
#print axioms TSCP.CustodyPlane.receipt_not_in_authority_plane
#print axioms TSCP.CustodyPlane.harness_is_evidence_generator
#print axioms TSCP.CustodyPlane.authority_reaches_evidence
#print axioms TSCP.CustodyPlane.authority_reaches_receipt
#print axioms TSCP.CustodyPlane.execution_reaches_receipt
#print axioms TSCP.CustodyPlane.authority_reach_into_custody_plane

#eval s!"Custody->Custody: {canReach Category.Custody Category.Custody}"
#eval s!"Custody->Evidence: {canReach Category.Custody Category.Evidence}"
#eval s!"Custody->AcceptanceReceipt: {canReach Category.Custody Category.AcceptanceReceipt}"
#eval s!"Custody->Authority: {canReach Category.Custody Category.Authority}"
#eval s!"Custody->Execution: {canReach Category.Custody Category.Execution}"
#eval s!"Evidence->Custody: {canReach Category.Evidence Category.Custody}"
#eval s!"Evidence->Evidence: {canReach Category.Evidence Category.Evidence}"
#eval s!"Evidence->AcceptanceReceipt: {canReach Category.Evidence Category.AcceptanceReceipt}"
#eval s!"Evidence->Authority: {canReach Category.Evidence Category.Authority}"
#eval s!"Evidence->Execution: {canReach Category.Evidence Category.Execution}"
#eval s!"AcceptanceReceipt->Custody: {canReach Category.AcceptanceReceipt Category.Custody}"
#eval s!"AcceptanceReceipt->Evidence: {canReach Category.AcceptanceReceipt Category.Evidence}"
#eval s!"AcceptanceReceipt->AcceptanceReceipt: {canReach Category.AcceptanceReceipt Category.AcceptanceReceipt}"
#eval s!"AcceptanceReceipt->Authority: {canReach Category.AcceptanceReceipt Category.Authority}"
#eval s!"AcceptanceReceipt->Execution: {canReach Category.AcceptanceReceipt Category.Execution}"
#eval s!"Authority->Custody: {canReach Category.Authority Category.Custody}"
#eval s!"Authority->Evidence: {canReach Category.Authority Category.Evidence}"
#eval s!"Authority->AcceptanceReceipt: {canReach Category.Authority Category.AcceptanceReceipt}"
#eval s!"Authority->Authority: {canReach Category.Authority Category.Authority}"
#eval s!"Authority->Execution: {canReach Category.Authority Category.Execution}"
#eval s!"Execution->Custody: {canReach Category.Execution Category.Custody}"
#eval s!"Execution->Evidence: {canReach Category.Execution Category.Evidence}"
#eval s!"Execution->AcceptanceReceipt: {canReach Category.Execution Category.AcceptanceReceipt}"
#eval s!"Execution->Authority: {canReach Category.Execution Category.Authority}"
#eval s!"Execution->Execution: {canReach Category.Execution Category.Execution}"
